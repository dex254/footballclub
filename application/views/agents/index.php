  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">list of all sapplies in store</h3>
      </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">sapplys info</h4>
                    <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            <a href="<?php echo base_url('index.php/agents/create/');?>">
                 						<button class="btn btn-primary btn-md">
                            <li><i class="fa fa-plus-circle"></i>New stock take</li></button></a>
                        </ul>
                    </div>
                </div>
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <table class="table table-striped table-bordered multi-ordering">
                            ...
                            <tbody>
                              <?php $i=1; foreach ($stock as $contact): ?>
                                <tr>
                                  <td><?php echo $i; $i++;?></td>
