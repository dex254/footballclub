...
<head>
    ...
    <title>Login  to Dex  football club </title>
        ...
        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
            <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                    ...
                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>Login to Dex football club</span></h6>
                </div>
                      ...
                      <?php echo form_open_multipart('login/verify',$attributes); ?>
                          <div class="form-group">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 col-12 text-center text-sm-right"><a href="<?php echo base_url('index.php/users/create/');?>"
